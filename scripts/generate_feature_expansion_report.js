...
async function exportPDF() {
  ...
  try {
    ...
    const htmlPath = path.resolve(__dirname, '../docs/COMPLETE_PLATFORM_REPORT.html');
    ...
    const outputPath = path.resolve(__dirname, '../reports/VERDICT_COMPREHENSIVE_FEATURE_REPORT.pdf');
    const rootOutputPath = path.resolve(__dirname, '../VERDICT_COMPREHENSIVE_FEATURE_REPORT.pdf');
    ...
    console.log('[4/4] PDF Generated Successfully: VERDICT_COMPREHENSIVE_FEATURE_REPORT.pdf');
    console.log('Saved to: ' + outputPath);
    console.log('Saved to: ' + rootOutputPath);
  } catch (error) {
